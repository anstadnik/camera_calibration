...
\begin{abstract}
	...
	% However, despite the constant development of solutions, they still tend to
	% be sensitive to the noise of the input data, bad lightning conditions,
	% occlusions and other problems, especially under the conditions of
	% high distortion, such as mobile phones and GoPro-type cameras.
	%
