...
\begin{abstract}
	...
	lens with medium to small distortion. Partially it occurs due to extreme
	...
	calibration by solving the two-steps linear minimization problem, and \((3)\)
	estimation the possible positions of the undetected features by projecting the
