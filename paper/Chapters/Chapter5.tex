...
However, the above statement assumes that the measurements are true positives.
...
\section{Additional features detection}\label{sec:additional_features_detection_exp}
